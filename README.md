...
Tokyo's Brotherhood is designed as a local-first media client inspired by applications such as Mihon, while developing its own anime video player, manga reader, extension system, library, history, downloads, and tracking features.
...
- JSON manifest parsing with Serde
